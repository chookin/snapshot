...
public class StringHelperTest {
    ...
    public void testParseStringStringMap() throws Exception {
        ...
        Assert.assertEquals("{RK=CSWyS2NdfZ, isVideo_DC=0, o_cookie=469308668, pgv_info=ssid=s6632480880, pgv_pvi=4184944640, pgv_pvid=2620759212, piao_city=10, pt2gguin=o0469308668, ptcz=0802eaad41f9d8893e3ee158457764b1c187a0447079210aa1e80db84c759b10, ptisp=cm, uid=25493040}",out.toString());
    ...
    public void testConvertHtmlLatin2UTF8() throws UnsupportedEncodingException {
        ...
        Assert.assertEquals("原来你的时间不只是我一个人。<br>故事的结局却让我增添多少伤痕？<br>有时候眼泪也就是 歪小九&#32;看到花朵的绽放了么？你的身边有人并肩而行么？收到过去的来信了么？<br>这ถ้าเธอมีจริง一片春色中", out);
    }
    ...
    public void testAppendNull(){
        String str = "me";
        String dst = str + null;
        Assert.assertEquals("menull", dst);
    }
