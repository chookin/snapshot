 ...
 */
@RestController
@RequestMapping("/shotComment")
public class ShotCommentController {
    /**
     * 对活动进行评论
     *
     * @param uid 用户id
    ...
    public ResponseMessage add(long uid, Long shotId, Long parent, String content){
        ...
        return CommentHelper.save(uid, shotId, ModelType.Shot, parent, content);
    }
    ...
    public ResponseMessage getAboutShot(long shotId, Integer page, Integer step){
        return CommentHelper.findComments(shotId, ModelType.Shot, page, step);
    }
}
